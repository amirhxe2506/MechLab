...
class StressStrainAPITests(APITestCase):
    ...
    def test_valid_si_input(self):
        ...
        self.assertAlmostEqual(response.data["stress"], 2e7, delta=1e-3)
        self.assertAlmostEqual(response.data["strain"], 1e-4, delta=1e-9)
        self.assertAlmostEqual(response.data["deformation"], 1e-4, delta=1e-9)
    ...
    def test_response_shape(self):
        ...
        self.assertEqual(
            ...
            {"stress", "strain", "deformation", "lateral_strain", "warnings"},
        )
